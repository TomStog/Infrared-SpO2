...
out_video_path = '..\Right_Cheek_out\';
...
for i=1:day_len
    ...
    for j=1:person_len
        ...
        for k=3:length(files)
            ...
            forehead_rect = [(fitbox(1,2)+round(3*fitbox(1,3)/5)), fitbox(1,1)+round(fitbox(1,3)/3 + 2*my_w), round(fitbox(1,3)/5), round(fitbox(1,3)/3-2*my_w)];
